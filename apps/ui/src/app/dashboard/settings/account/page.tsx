  ...
  return (
    <div className="flex h-full flex-col overflow-auto">
      <div className="mx-auto w-full max-w-2xl p-5 space-y-8">
        <div>
          <h1 className="text-[15px] font-semibold">Subscription & Billing</h1>
          <p className="text-[12px] text-muted-foreground mt-0.5">
            Manage your workspaces, subscription plan, and payment details.
          </p>
        </div>
        ...
        <section className="space-y-3">
          <div className="flex items-center justify-between">
            <h2 className="text-[13px] font-medium">Workspaces</h2>
            <a
              href="/signup"
        ...
        {/* Billing */}
        <section className="space-y-3">
          <h2 className="text-[13px] font-medium">Billing</h2>
