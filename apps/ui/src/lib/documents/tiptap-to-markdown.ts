// Converts Tiptap JSONContent back to a markdown string.
// Inverse of markdownToTiptap() in markdown-to-tiptap.ts.
...
function serializeListItemContent(item: JSONContent): string {
  ...
  // List items contain paragraph(s) — serialize the first paragraph inline,
  // and any additional nodes as nested content
