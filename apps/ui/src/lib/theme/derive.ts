...
export function deriveDarkTokens(
  ...
  return {
    background: oklch(0.14, warmth * 1.25, bh),
    foreground: oklch(0.93, warmth, bh),
    card: oklch(0.17, warmth * 1.25, bh),
    "card-foreground": oklch(0.93, warmth, bh),
    popover: oklch(0.19, warmth * 1.25, bh),
    "popover-foreground": oklch(0.93, warmth, bh),
    muted: oklch(0.20, warmth * 1.25, bh),
    "muted-foreground": oklch(0.60, warmth * 2, bh),
    accent: oklch(0.22, warmth * 1.5, bh),
    "accent-foreground": oklch(0.93, warmth, bh),
    secondary: oklch(0.21, warmth * 1.25, bh),
    "secondary-foreground": oklch(0.90, warmth, bh),
    primary: oklch(darkBrand.l, darkBrand.c, darkBrand.h),
    "primary-foreground": oklch(0.14, warmth * 1.25, bh),
