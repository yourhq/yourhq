...
export const CONTEXT_PRESETS: ContextPreset[] = [
  {
    ...
    description: "Find prospects, close deals, build partnerships, grow your network.",
    emoji: "🚀",
    pipelineKey: "sales",
    fieldKey: "sales",
  ...
  },
  {
    ...
    description: "Write newsletters, posts, and threads — publish across platforms.",
    emoji: "✍️",
    pipelineKey: "custom",
    fieldKey: "blank",
  ...
  },
  {
    ...
    description: "Track accounts, manage deliverables, keep projects on schedule.",
    emoji: "🤝",
    pipelineKey: "clients",
    fieldKey: "clients",
    streamNames: ["Operations", "Content"],
  ...
  },
  {
    key: "hire",
    label: "Hiring people",
    description: "Source candidates, screen profiles, move them through your pipeline.",
    emoji: "🧑‍💼",
  ...
  },
  {
    ...
    description: "Dig into markets, companies, trends — organize what you find.",
    emoji: "🔍",
    pipelineKey: "custom",
    fieldKey: "blank",
    streamNames: ["Operations"],
  ...
  },
  {
    ...
    description: "Manage tasks, track what matters, keep everything in one place.",
    emoji: "✏️",
    pipelineKey: "custom",
    fieldKey: "blank",
    streamNames: ["Operations"],
