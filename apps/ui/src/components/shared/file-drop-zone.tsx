...
interface FileDropZoneProps {
  ...
  disabled?: boolean;
  /** File extensions to accept (e.g. [".md", ".markdown"]). Omit to accept all files. */
  accept?: string[];
  /** Label for the drop overlay */
  label?: string;
  /** Description for the drop overlay */
  description?: string;
...
export function FileDropZone({
  ...
  description = "Files will be added to your library",
  children,
}: FileDropZoneProps) {
