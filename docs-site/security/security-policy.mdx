...
- **Service-role key**: decrypted at provisioning time and passed to your gateway sandbox. After provisioning, the worker only decrypts it when the UI requests your project config (to connect your browser to your Supabase). We do not read your Supabase data.
