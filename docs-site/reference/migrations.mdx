...
| `011_assets_documents.sql` | Knowledge items, chunks, search RPCs, and draft sets |
| `012_audit_notifications.sql` | Audit log and notifications |
| `013_agent_inbox.sql` | Inbox queue and routine triggers |
...
| `023_entity_links.sql` | Universal polymorphic entity linking |
| `025_routines.sql` | Routines (scheduled agent workflows) |
| `026_collections.sql` | Custom collections and records |
| `027_file_processing.sql` | File processing pipeline |
| `028_source_connections.sql` | External source connections |
| `029_routines_extension.sql` | Routine extensions |
