...
Migrations live in [`db/migrations/`](https://github.com/yourhq/yourhq/tree/main/db/migrations). Run them in filename order for a fresh project. There are currently 31 migration files (001–031).
...
| `027_source_plugin_support.sql` | Extensible source providers, `writable` flag, `source_write` command action |
