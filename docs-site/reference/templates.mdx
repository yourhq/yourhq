...
| Script | Purpose |
|---|---|
| `hq_playbook_upsert.py` | Create or update agent-scoped playbooks with auto-embedding and junction linking |
| `hq_search_docs.py` | Semantic + full-text search across knowledge items |
| `hq_create_doc.py` | Create a new knowledge item (page or playbook) |
