...
HQ's default Compose stack has six services that work together. The UI runs on its own; the other five are gateway services that run agents and process data.
