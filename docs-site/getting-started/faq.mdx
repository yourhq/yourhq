...
<AccordionGroup>
  ...
  <Accordion title="How long does it take to get started?">
    ...
    The onboarding wizard handles database setup automatically — no manual SQL needed.
...
<AccordionGroup>
  ...
  <Accordion title="What agent templates are included?">
    HQ ships 17 built-in templates:

    `default`, `analytics`, `assistant`, `chief-of-staff`, `cmo`, `cofounder`, `crm-researcher`, `data-analyst`, `designer`, `ghostwriter`, `market-researcher`, `newsletter-editor`, `newsletter-writer`, `sales-copywriter`, `script-writer`, `social-strategist`, `social-writer`
