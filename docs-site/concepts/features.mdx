...
Templates are role-specific starting points for agents. The repository ships 17 templates: default, analytics, assistant, chief of staff, CMO, cofounder, CRM researcher, data analyst, designer, ghostwriter, market researcher, newsletter editor, newsletter writer, sales copywriter, script writer, social strategist, and social writer.
