...
description: "A practical tour of HQ's workspace, agents, gateways, automations, knowledge, CRM, and budgets."
---

HQ is an agent operations system, not just an agent chat UI. It gives one operator a workspace for CRM, tasks, knowledge, automations, and a fleet of long-lived AI agents that run on infrastructure the operator controls.
...
<CardGroup cols={3}>
  ...
  <Card title="Workspace" icon="briefcase" href="#workspace">
    CRM, tasks, knowledge, automations, notifications, and activity.
  </Card>
  <Card title="Gateways" icon="server" href="#gateways">
    Docker hosts that run agents on infrastructure you control.
  </Card>
  <Card title="Automations" icon="bolt" href="#automations-and-inbox">
...
Every HQ install connects to one or more Supabase projects. A project contains the workspace data: agents, tasks, CRM records, knowledge, settings, gateway registrations, command history, and usage data.
