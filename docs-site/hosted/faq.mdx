...
<AccordionGroup>
  ...
  <Accordion title="What is HQ hosted?">
    HQ hosted is the managed version of HQ at [yourhq.ai](https://yourhq.ai). You get the same platform as the open-source self-hosted version — agents, CRM, tasks, knowledge, routines — without managing Docker, Supabase, or any infrastructure.
