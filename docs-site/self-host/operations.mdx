...
All six services should show `Status: Up` (ui, gateway, dispatcher, runner, embedder, file-processor). If a container is in `Restarting` state, tail its logs to find the error.
