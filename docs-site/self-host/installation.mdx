...
3. Open SQL Editor and run every `.sql` file in [`db/migrations/`](https://github.com/yourhq/yourhq/tree/main/db/migrations) in filename order (`001` through `025`). Each file is named descriptively. The onboarding wizard handles this automatically if you set up through the browser.
