...
<Steps>
  ...
  <Step title="Agent reads it automatically">
    The next time an agent wakes up (via a message, a task, or an automation), it reads the item as part of its startup context. No restart required — changes take effect on the next session.
  </Step>
</Steps>
