...
<Info>
  Your first provider is connected during the [onboarding wizard](/guides/workspace-setup#wizard-steps). This page covers adding additional providers or managing existing ones from **Settings → Connections**.
</Info>
