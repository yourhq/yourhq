...
<Tabs>
  <Tab title="API key providers">
    ...
    |---|---|---|
    | **OpenAI** (GPT-4.1, o3, o4-mini) | [platform.openai.com/api-keys](https://platform.openai.com/api-keys) | ~$0.01–0.06 per 1K tokens |
    | **Anthropic** (Claude Opus, Sonnet, Haiku) | [console.anthropic.com/settings/keys](https://console.anthropic.com/settings/keys) | ~$0.003–0.075 per 1K tokens |
